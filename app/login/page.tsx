...
export default async function LoginPage(props: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    ...
    <div className='flex flex-col font-poppins items-center justify-center min-h-screen gap-[2rem]'>
      ...
      <form action={login} className='flex flex-col gap-[0.75rem] px-[2rem] w-[28rem] rounded-lg'>
        {/* <label htmlFor="email">Email:</label> */}
        <input id="email" name="email" type="email" required placeholder='Email' 
        className='border border-stone-600 bg-stone-900 px-[1.5rem] py-[1rem] rounded-full' />
